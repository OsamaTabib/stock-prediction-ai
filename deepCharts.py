...
GOOGLE_API_KEY = "AIzaSyDi_7F16aIRVl76hC3wfMpNeJlFLe4HvMQ" 
...
if st.sidebar.button("Fetch Data"):
    ...
    for ticker in tickers:
        try:
            ...
            if not data.empty:
                ...
                st.warning(f"No data found for {ticker}. It might be delisted or unavailable.")
    ...
    if stock_data:
        ...
        st.error("No stock data could be retrieved. Please check the ticker symbols and date range.")
